...
// GetNodeParams contains all the bound params for the get node operation
// typically these are obtained from a http.Request
//
// swagger:parameters getNode
...
func (o *GetNodeParams) bindDatetime(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetNodeParams) validateDatetime(formats strfmt.Registry) error {
...
func (o *GetNodeParams) bindNodeID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
