...
// CreateDirectoryParams contains all the bound params for the create directory operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateDirectoryParams() beforehand.
func (o *CreateDirectoryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateDirectory
...
func (o *CreateDirectoryParams) bindDatetime(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateDirectoryParams) validateDatetime(formats strfmt.Registry) error {
