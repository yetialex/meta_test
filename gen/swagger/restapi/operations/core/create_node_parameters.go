...
func (o *CreateNodeParams) bindDatetime(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateNodeParams) validateDatetime(formats strfmt.Registry) error {
